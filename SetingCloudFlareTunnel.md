...
services:
  ...
  # An example app to expose (e.g., a simple web server)
  webapp:
    container_name: test-app
    image: nginxdemos/hello
    restart: unless-stopped
    # Note: We do NOT need to map ports to the host (e.g., 80:80)
    # Cloudflared communicates with this via the Docker internal network.
